...
class DisputeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'attachments.*' => 'file|mimes:jpg,jpeg,png,pdf,doc,docx|max:5120', // Validation des fichiers
        ]);
    ...
    public function sendMessage(Request $request, Dispute $dispute)
    {
        ...
        try {
            foreach ($recipients as $recipient) {
                ...
                $recipient->notify(new DisputeMessageNotification($dispute, $user->firstname . ' ' . $user->lastname));
            }
        } catch (\Exception $e) {
